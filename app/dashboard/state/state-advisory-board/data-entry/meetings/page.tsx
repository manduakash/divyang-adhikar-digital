            ...
            <div className="flex flex-col md:flex-row justify-between items-start md:items-center gap-6 mb-10">
                <div className="space-y-1">
                    <div className="flex items-center gap-2 text-emerald-600 font-black uppercase text-[10px] tracking-[0.2em]">
                        <ArrowLeft size={14} /> Advisory Hub / A3.2 Data Entry
                    </div>
                ...
                <div className="lg:col-span-8 space-y-8">
                    ...
                    <Card className="rounded-[40px] border-slate-200 shadow-2xl overflow-hidden bg-white relative">
                        ...
                        <CardHeader className="p-8 border-b border-slate-50 bg-slate-50/50 relative z-10">
                            <CardTitle className="text-[10px] font-black uppercase tracking-[0.3em] text-slate-400">Section A3.2: Statutory Meeting Parameters</CardTitle>
                        </CardHeader>
                        ...
                        <CardContent className="p-10 space-y-10 relative z-10">
                            ...
                            <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                                <div className="space-y-3">
                                    ...
                                    <Select>
                                        <SelectTrigger className="h-16 rounded-2xl bg-slate-50 border px-6 font-bold text-slate-800">
