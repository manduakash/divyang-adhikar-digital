    ...
    <div className="space-y-8 animate-in fade-in duration-700 pb-20">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
        ...
        <div className="space-y-6">
            <Card className="rounded-[40px] border-none bg-red-600 text-white p-8 shadow-2xl relative overflow-hidden group">
      ...
      <Card className="rounded-[40px] border-slate-200 shadow-sm overflow-hidden bg-white">
        <CardHeader className="p-8 border-b border-slate-50 flex flex-row justify-between items-center">
            ...
            <div className="relative">
                ...
                <input className="pl-10 pr-4 py-2 bg-slate-50 border-none rounded-xl text-xs font-bold outline-none w-64" placeholder="Search Establishment..." />
            </div>
        </CardHeader>
