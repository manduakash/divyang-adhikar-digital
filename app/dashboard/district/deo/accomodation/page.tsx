...
function NewRequestDialog() {
    return (
        <Dialog>
            ...
            <DialogContent className="max-w-2xl rounded-[40px] p-0 border-2 overflow-hidden font-sans">
                ...
                <div className="p-10 space-y-6 bg-white">
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                        <div className="space-y-2">
                            ...
                            <Input className="h-12 bg-slate-50 border-2 rounded-xl font-bold" placeholder="School Name" />
                        </div>
                        <div className="space-y-2">
                            <label className="text-[10px] font-black uppercase text-slate-400 ml-1">Student Category</label>
                            <Select><SelectTrigger className="h-12 bg-slate-50 border-2 rounded-xl font-bold"><SelectValue placeholder="Select Category" /></SelectTrigger></Select>
                        </div>
                        <div className="space-y-2 md:col-span-2">
                            <label className="text-[10px] font-black uppercase text-slate-400 ml-1">Accommodation Required</label>
                            <Select>
                                <SelectTrigger className="h-12 bg-slate-50 border-2 rounded-xl font-bold">
                        ...
                        <div className="md:col-span-2 space-y-2">
                            ...
                            <Input className="h-12 bg-slate-50 border-2 rounded-xl font-bold" placeholder="Specific details or serial numbers..." />
                        </div>
                    </div>
    ...
    return (
        <TableRow className="border-2 hover:bg-slate-50 transition-colors group">
            ...
            <TableCell className="text-center">
                <Badge className={`rounded-full px-3 py-1 text-[9px] font-black uppercase border-2 shadow-none ${provided === 'Yes' ? 'bg-green-100 text-green-700' : 'bg-red-100 text-red-700 animate-pulse'
                    }`}>
