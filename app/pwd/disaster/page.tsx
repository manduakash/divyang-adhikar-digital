    ...
    <div className="max-w-6xl mx-auto space-y-8 animate-in fade-in duration-700">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-8 items-start">
        ...
        <div className="lg:col-span-1 space-y-6">
                    ...
                    {activeTab === 'PREPAREDNESS' ? (
                        ...
                        <>
                            ...
                            <div className="space-y-2">
                                ...
                                <Textarea className="min-h-[80px] rounded-xl bg-slate-50 border-none p-3 resize-none text-sm" placeholder="List critical medicines needed..." />
                            </div>
                        ...
                        <>
                            ...
                            <div className="space-y-2">
                                ...
                                <Select>
                                    <SelectTrigger className="rounded-xl h-11 bg-red-50 border-none px-4 text-red-700 font-bold">
                            ...
                            <div className="space-y-2">
                                ...
                                <Textarea className="min-h-[80px] rounded-xl bg-slate-50 border-none p-3 resize-none text-sm" placeholder="Briefly describe your situation..." />
                            </div>
            ...
            {/* ADVISORY CARD */}
            <Card className="rounded-[32px] bg-slate-900 p-6 text-white shadow-xl border-none">
