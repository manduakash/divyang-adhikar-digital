    ...
    <div className="max-w-6xl mx-auto pb-20 animate-in fade-in duration-700">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
          ...
          <Card className="border-slate-200 rounded-[32px] shadow-sm overflow-hidden bg-white">
            ...
            <CardContent className="p-8 space-y-8">
              ...
              {reportType === 'PHYSICAL_ACCESS' && (
                <div className="space-y-6 animate-in slide-in-from-left-2 duration-300">
                    <div className="p-6 bg-orange-50/50 border border-orange-100 rounded-2xl flex items-center justify-between">
                        ...
                        <Badge className="bg-green-100 text-green-700 border-none font-bold">Location Locked</Badge>
                    </div>
                    <div className="space-y-2">
                        ...
                        <div className="relative">
                            ...
                            <Input className="pl-11 h-12 bg-slate-50 border-none rounded-xl" placeholder="e.g. Near Entry Gate 2, Metro Station" />
                        </div>
                    </div>
                </div>
              )}
                ...
                <div className="space-y-6 animate-in slide-in-from-left-2 duration-300">
                    <div className="space-y-2">
                        ...
                        <div className="relative">
                            ...
                            <Input className="pl-11 h-12 bg-slate-50 border-none rounded-xl" placeholder="https://example-government-portal.gov.in" />
                        </div>
                    </div>
                </div>
              )}
              ...
              <div className="space-y-4">
                ...
                <Textarea 
                  className="min-h-[140px] rounded-2xl bg-slate-50 border-none p-4 resize-none placeholder:text-slate-400 font-medium" 
        ...
        <div className="space-y-6">
            <Card className="rounded-[32px] border-none bg-gradient-to-br from-slate-900 to-slate-800 text-white shadow-xl p-8">
