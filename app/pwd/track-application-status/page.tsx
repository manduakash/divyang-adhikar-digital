    ...
    return (
        <div className="space-y-6 animate-in fade-in duration-700">
            ...
            <div className="flex flex-col md:flex-row justify-between items-start md:items-end gap-4 bg-white p-8 rounded-[32px] border border-slate-200 shadow-sm">
                ...
                <div className="flex gap-3 w-full md:w-auto">
                    <div className="relative flex-1 md:w-80">
                        ...
                        <input
                            className="w-full pl-10 pr-4 py-2.5 bg-slate-50 border-none rounded-xl text-sm font-medium focus:ring-2 focus:ring-blue-500 transition-all outline-none"
            ...
            <div className="flex flex-col md:flex-row gap-6">
                <Card className="flex-1 rounded-[32px] border-none bg-slate-900 p-8 text-white shadow-xl">
